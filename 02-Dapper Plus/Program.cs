...
Що вміє Dapper Plus
BulkInsert — вставити багато рядків
BulkUpdate — оновити багато рядків
BulkDelete — видалити багато рядків
BulkMerge — вставити (якщо це нове) або оновити (якщо це старе)
 */
...
using Z.Dapper.Plus; // беремо модель User з _01_Dapper.Models (іншого проекту: 01-Dapper)
...
{
    new User { Name = "Andrii", Email = "a@example.com", Password = "a1234" },
    new User { Name = "Mark", Email = "mark@gmail.com", Password = "mark111" }
};
...
users.Add(new User { Name = "Kateryna", Email = "kate.example.com", Password = "kate_12" }); // додаємо нового користувача до списку, який буде доданий або оновлений у таблиці Users
